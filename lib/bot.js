...
/**
 * Keep request or response headers of actions
 *
 * @param {String} type
 * @param {Object} obj
 * @api private
 ...
 *
 * TODO
 * arguments should be function
 */

Bot.prototype.trigger = function(obj) {
  return this.sendRequest(obj.write, obj.fn);
};
