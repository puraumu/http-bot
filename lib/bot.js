 ...
 * @api public
 */
log.__defineGetter__('head', function() {
  return this.res;
})

log.__defineGetter__('status', function() {
  return this.res.statusCode;
})

log.__defineGetter__('type', function() {
  return this.res.headers['content-type'];
})

log.__defineGetter__('html', function() {
  return this.res.headers['content-type'].indexOf('text/html') == 0;
})

log.__defineGetter__('exist', function() {
  return this.req.exist;
})

log.__defineGetter__('length', function() {
  return parseInt(this.res.headers['content-length']);
})

log.__defineGetter__('path', function() {
  return this.res.request.path;
})
