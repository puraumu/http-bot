...
view.req = function() {
  ...
  stout += exist + " " + '\033[35m' + method + '\033[0m' + " " + url;
...
view.res = function() {
  ...
  stout += exist + " " + '\033[35m' + statusCode + '\033[0m' + " " + url;
  console.log(stout);
...
view.writeErrors = function(name) {
